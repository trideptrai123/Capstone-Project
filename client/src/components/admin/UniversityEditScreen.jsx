...
const UniversityEditScreen = () => {
  ...
  const [updateUniversity, { isLoading: loadingUpdate }] =
    useUpdateUniversityMutation();
              ...
              <div key={index} className="my-2">
                ...
                <Form.Group controlId={`subject-sector-${index}`}>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      handleSubjectChange(index, "sector", e.target.value)
                    }
                  >
                    <option value="">Select sector</option>
                    <option value="high quality program">
                ...
                <Form.Group controlId={`subject-entryPoints-${index}`}>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      handleSubjectChange(index, "entryPoints", e.target.value)
                    }
                  ></Form.Control>
                </Form.Group>
                <Button

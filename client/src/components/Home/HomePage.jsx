...
const FeatureCard = ({ title, description, icon,path }) => {
  return (
    ...
    <div
      data-aos="fade-up"
      className="bg-white p-6 rounded-lg text-center  flex flex-col justify-start items-center"
    >
...
const Home = () => {
  ...
  return (
    <div className="p-6 bg-white">
      <header
        className="header-background text-center text-white py-16"
        data-aos="fade-down"
      >
        <h1 className="text-5xl font-bold mb-4">Chào mừng đến với chúng tôi</h1>
        <p className="text-xl mb-6">
          Khám phá các tính năng và cập nhật mới nhất
        </p>
       {
        !userInfo &&  <Link
        to="/register"
        className="inline-block bg-white text-purple-500 hover:bg-gray-200 font-bold py-3 px-6 rounded-full transition-colors duration-300 get-started-btn"
      >
        Đăng ký
      </Link>
       }
